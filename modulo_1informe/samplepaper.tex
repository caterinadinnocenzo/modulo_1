...
\section{Conclusión}
En este trabajo aprendí a usar mejor distintos lenguajes de marcado como HTML, Markdown y LaTeX, y entendí para qué sirve cada uno. Pude agregar cosas más completas como links, tablas, imágenes y formato de texto, lo que hace que los documentos queden mucho más prolijos.

Siento que ahora tengo más herramientas para hacer trabajos, ya sea para la facultad o algo más profesional. Sobre todo LaTeX me parece muy útil para el futuro en la carrera, y Markdown para cosas rápidas.

En general, pasé de no entender mucho a poder armar documentos bastante completos y organizados, lo cual me va a servir un montón más adelante.
